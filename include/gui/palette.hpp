...
namespace gui::palette
{
	namespace hex
	{
		constexpr std::string_view black  = "000000FF";
		constexpr std::string_view white  = "FFFFFFFF";
	...
	namespace rgb
	{
		constexpr glm::uvec4 black  = {0,   0,   0,   255}; // #000000FF
		constexpr glm::uvec4 white  = {255, 255, 255, 255}; // #FFFFFFFF
